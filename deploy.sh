...
curl -H "Content-Type: application/json" --data "{"source_type": "Branch", "source_name": "$CIRCLE_BRANCH"}" -X POST https://registry.hub.docker.com/u/mfoll/robust-regression-caller/trigger/e85e32e7-508d-4971-b621-e1a0409f711a/
