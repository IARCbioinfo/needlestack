...
if(params.input_vcf) {
  ...
  process compilationCpp {
      output:
      file "mpileup2readcounts" into executable
      
      shell:
      '''
      g++ -std=c++11 -O3 !{baseDir}/bin/mpileup2readcounts.cc -o mpileup2readcounts
      '''
  }
  ...
  process mpileup2vcf {
      ...
      input:
      file mpileup2readcounts from executable
      file split_bed
      file 'BAM/*' from bam
      file 'BAM/*' from bai
      file fasta_ref
