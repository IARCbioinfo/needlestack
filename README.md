...
| input_vcf |   | A vcf file (basically from GATK) where calling should be done. Needlestack will use DP and AO from this vcf. WARNING: by default, only work with split (coreutils) version > 8.13 |
